/*
==================================================================================
Stored Procedure: Loas Silver Layer (Bronze -> Silver)
==================================================================================
Script Purpose:
  This stored procedure performs the ETL (Extract, Transform, Load) process to 
  populate the 'sivler' schema tables from the 'bronze' schema.
Actions Performed:
...
AS $$
BEGIN 
		  --               ***********Insert into Silver silver.crm_cust_info*****************
	...
	FROM (
	       ...
	       --               ***********Insert into Silver silver.crm_prd_info*****************
	...
	SELECT 
	    prd_id,
	    REPLACE(SUBSTRING(prd_key,1,5),'-','_') AS cat_id,               -- correct position
	    SUBSTRING(prd_key,7,LENGTH(prd_key)) AS prd_key,                 -- correct position
	    prd_nm,
	...
	SELECT 
		...
		FROM bronze.erp_cust_a212;
	       ...
	       --               ***********Insert into Silver silver.erp_loc_a101*****************
